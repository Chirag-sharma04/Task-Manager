        ...
        <main className="flex-1 p-6 overflow-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-semibold dark:text-white">Welcome back, amanuel 👋</h2>

              <div className="flex items-center gap-2">
                {teamMembers.map((avatar, index) => (
                  <Avatar key={index} className="w-8 h-8 border-2 border-white dark:border-gray-700">
                    <AvatarImage src={avatar || "/placeholder.svg"} />
                    <AvatarFallback className="bg-coral-500 text-white">U{index + 1}</AvatarFallback>
                  </Avatar>
                ))}
                <Button
                  size="sm"
              ...
              <div className="lg:col-span-2">
                <Card className="dark:bg-gray-800 dark:border-gray-700">
                  <CardContent className="p-6">
                    ...
                    <div className="mb-4">
                      <p className="text-sm text-gray-600 dark:text-gray-400">20 June • Today</p>
                    </div>

                    <div className="space-y-4">
                      {sampleTasks.map((task) => (
                        <Card key={task.id} className="border border-gray-200 dark:border-gray-600 dark:bg-gray-700">
                          <CardContent className="p-4">
                            <div className="flex gap-4">
                              ...
                              <div className="w-16 h-16 bg-gray-100 dark:bg-gray-600 rounded-lg flex-shrink-0">
                                <Image
                ...
                <Card className="dark:bg-gray-800 dark:border-gray-700">
                  <CardContent className="p-6">
                    <div className="flex items-center gap-2 mb-4">
                      <div className="w-5 h-5 bg-gray-100 dark:bg-gray-600 rounded flex items-center justify-center">
                        <div className="w-2 h-2 bg-gray-400 rounded"></div>
                      </div>
                      <h3 className="font-semibold dark:text-white">Task Status</h3>
                    </div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="text-center">
                        <div className="relative w-20 h-20 mx-auto mb-2">
                          ...
                          <div className="absolute inset-0 flex items-center justify-center">
                            <span className="text-lg font-bold dark:text-white">84%</span>
                          </div>
                        </div>
                      ...
                      <div className="text-center">
                        <div className="relative w-20 h-20 mx-auto mb-2">
                          ...
                          <div className="absolute inset-0 flex items-center justify-center">
                            <span className="text-lg font-bold dark:text-white">46%</span>
                          </div>
                        </div>
                        <div className="flex items-center justify-center gap-2">
                      ...
                      <div className="text-center">
                        <div className="relative w-20 h-20 mx-auto mb-2">
                          ...
                          <div className="absolute inset-0 flex items-center justify-center">
                            <span className="text-lg font-bold dark:text-white">13%</span>
                          </div>
                        </div>
                        <div className="flex items-center justify-center gap-2">
                          <div className="w-2 h-2 bg-red-500 rounded-full"></div>
                          <span className="text-sm dark:text-gray-300">Not Started</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
